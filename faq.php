				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><bdo dir="rtl"> الاسئلة الشائعة</bdo></li>
						</ol>
					</nav>
				</div>
			</div>
						...
						<div class="accordion" id="gq-faqs-1">
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0">
										<button class="collapsed" data-toggle="collapse" data-target="#gq-faq-1">
								...
								<div id="gq-faq-1" class="collapse show" data-parent="#gq-faqs-1">
									<div class="card-body">
										<p>Proin libero tellus, interdum ac pellentesque ac, malesuada a velit. Nullam
											fermentum massa nec sem condimentum, fermentum commodo felis accumsan.</p>
									</div>
								</div>
							</div>
							<!--Cart End-->
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-2">Vivamus feugiat, eros pretium porta ?</button></h5>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-3">Donec molestie vitae turpis a efficitur ?</button>
									</h5>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-4">Nullam dignissim lectus diam, vitae elementum
											?</button></h5>
								</div>
					...
					<div class="col-lg-6 col-12 accordion-2">
						...
						<div class="accordion" id="gq-faqs-2">
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-5">Lorem ipsum dolor sit amet, consectetur adipisc
											?</button></h5>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-6">Vivamus feugiat, eros pretium porta ?</button></h5>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-7">Donec molestie vitae turpis a efficitur ?</button>
									</h5>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<h5 class="mb-0"><button class="collapsed" data-toggle="collapse"
											data-target="#gq-faq-8">Nullam dignissim lectus diam, vitae elementum
											?</button></h5>
								</div>
